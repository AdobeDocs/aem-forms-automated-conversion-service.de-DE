...
Der [Dienst für die automatisierte Formularkonvertierung (AFCS)](/help/using/introduction.md) konvertiert die folgenden Quellformulare in adaptive Formulare:
...
Wenn Sie ein nicht-interaktives PDF-Formular als Quellformular für den Dienst für die automatisierte Formularkonvertierung (AFCS) verwenden, haben Sie folgende Möglichkeiten:
...
Wenn Sie ein Acro Form oder ein XFA-basiertes PDF-Formular als Quellformular für den Dienst für die automatisierte Formularkonvertierung (AFCS) verwenden, haben Sie folgende Möglichkeiten:
